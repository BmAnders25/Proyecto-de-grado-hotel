...
@can('crear-reservas') <a class="btn btn-primary mr-2" href="{{ route('reservas.create') }}" role="button"> <i class="fa fa-plus"></i> Registrar Reserva </a>
@endcan
    ...
    <x-adminlte-datatable id="table1" 
        ...
        @foreach ($reservas as $reserva)
            ...
            <tr>
                ...
                <td>
                    <a class="btn btn-info" href="{{ route('reservas.show', $reserva->id) }}" role="button">
                        <i class="far fa-eye fa-fw"></i>
                    </a>

                    @can('editar-reservas')
                        <a class="btn btn-success" href="{{ route('reservas.edit', $reserva->id) }}" role="button">
