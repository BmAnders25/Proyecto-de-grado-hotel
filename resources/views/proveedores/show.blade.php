...
@section('content_header') <h1 class="m-0 text-dark">Detalle del Proveedor</h1>
@stop

@section('content') 
<x-adminlte-card> <div class="row">
    ...
    <div class="row mt-3">
        <div class="col-md-6">
            <a class="btn btn-secondary" href="{{ route('proveedores.index') }}">
