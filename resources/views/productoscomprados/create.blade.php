...
@section('content_header')
    <h1 class="m-0 text-dark">Registrar Compra de Producto</h1>
@stop

@section('content')
<x-adminlte-card>
    <form method="POST" action="{{ route('productoscomprados.store') }}">
        @csrf
        ...
        <div class="row">
            {{-- Unidades --}}
            <x-adminlte-input name="unidades" label="Unidades" type="number" min="1" fgroup-class="col-md-6" required />

            {{-- Precio (readonly, se actualiza según el producto) --}}
            <x-adminlte-input name="precio" label="Precio" type="number" step="0.01" fgroup-class="col-md-6" readonly />
        </div>
        ...
        <div class="row mt-3">
            <div class="form-group col-md-6">
                <x-adminlte-button class="btn btn-primary mr-2" type="submit" label="Registrar Compra" theme="primary" icon="fas fa-save" />
...
@section('footer')
<footer>
    <p><img src="{{ asset('vendor/adminlte/dist/img/fralgom-foot.png') }}" alt="Logo Fralgom"> © {{ date('Y') }} Fralgóm Ingeniería Informática. Todos los derechos reservados.</p>
</footer>
@stop
