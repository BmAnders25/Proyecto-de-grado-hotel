    ...
    <x-adminlte-card>
        <form method="POST" action="{{ route('clientes.store') }}" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <x-adminlte-input name="telefono" label="Telefono" placeholder="Telefono del Cliente"
            ...
            <div class="row">
                <div class="form-group col-md-6">
                    <x-adminlte-button class="btn btn-primary mr-2" type="submit" label="Guardar Cliente" theme="primary"
                        icon="fas fa-save" />
                    <a href="{{ route('clientes.index') }}" class="btn btn-secondary mr-2"><i
